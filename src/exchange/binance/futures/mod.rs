...
//     ExchangeTransformer, Subscriber, Subscription, SubscriptionMap, SubscriptionMeta,
// };
...
// mod tests {
//     use super::*;
//     use crate::exchange::binance::model::{BinanceLiquidation, BinanceLiquidationOrder, BinanceMessage, BinanceTrade};
//     use crate::model::{Liquidation, MarketEvent};
